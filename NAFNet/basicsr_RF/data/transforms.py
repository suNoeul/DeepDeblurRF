...
def paired_random_crop(img_gts, img_lqs, img_lq2s, gt_patch_size, scale, gt_path):
    """Paired random crop.
    ...
    return img_gts, img_lqs, img_lq2s


def paired_random_crop_sat(img_gts, img_lqs, img_sats, img_lq2s, gt_patch_size, scale, gt_path):
    """Paired random crop.
    ...
    Args:
        ...
        img_lqs (list[ndarray] | ndarray): LQ images. Note that all images
            should have the same shape. If the input is an ndarray, it will
            be transformed to a list containing itself.
        img_sats (list[ndarray] | ndarray): Saturation mask images. Note that all images
            should have the same shape. If the input is an ndarray, it will
            be transformed to a list containing itself.
        gt_patch_size (int): GT patch size.
        scale (int): Scale factor.
    ...
    if not isinstance(img_lqs, list):
        img_lqs = [img_lqs]
    if not isinstance(img_sats, list):
        img_sats = [img_sats]
    if not isinstance(img_lq2s, list):
        img_lq2s = [img_lq2s]
    ...
    return img_gts, img_lqs, img_sats, img_lq2s
