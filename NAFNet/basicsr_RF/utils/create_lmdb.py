...
def create_lmdb_for_gopro():
    ...
    folder_path = './datasets/GoPro/train/render_crops'
    lmdb_path = './datasets/GoPro/train/render_crops.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
####################################################240417
def create_lmdb_for_deblurringnerf():
    folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/blur_crops'
    lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/blur_crops.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/render_crops'
    lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/render_crops.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/sharp_crops'
    lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/sharp_crops.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    
    folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/sat_mask_crops'
    lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/train/sat_mask_crops.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

####################################################################################

    # folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/test/blur_crops'
    # lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/test/blur_crops.lmdb'
    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/test/render_crops'
    # lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/test/render_crops.lmdb'
    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # folder_path = 'C:/Users/owner/Desktop/NAFNet_4th/test/sharp_crops'
    # lmdb_path = 'C:/Users/owner/Desktop/NAFNet_4th/test/sharp_crops.lmdb'
    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
